...
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaSun, FaMoon } from "react-icons/fa";
import { SiX } from "react-icons/si"; // ⬅️ NEW X ICON
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="flex gap-4 mt-2">
                ...
                {/* 🔥 NEW X (Twitter) ICON */}
                <a href="#" className="hover:text-black dark:hover:text-gray-300 transition text-xl ">
                  <SiX />
                </a>
